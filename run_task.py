...
from security_incident_management import (
    correlate_security_cases, execute_playbook,
    build_executive_report, render_executive_report_pdf
)
...
report_state = {'incident_id':'demo_incident_001','correlation_id':case.get('case_key'),'executive_summary':{'threat_level':'high','recommended_actions':case.get('recommended_actions',[])},'integrity_hash':case.get('integrity_hash')}

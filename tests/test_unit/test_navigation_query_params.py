...
def test_get_requested_page_reads_query_param(monkeypatch):
    monkeypatch.setattr(app_module.st, "query_params", {"page": "Home"}, raising=False)

    assert app_module.get_requested_page() == "Home"

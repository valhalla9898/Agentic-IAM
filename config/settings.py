...
class Settings:
    ...
    def __init__(self, **overrides):
        ...
        self.api_port: int = int(
            overrides.get(
                "api_port", os.getenv("AGENTIC_IAM_API_PORT", os.getenv("API_PORT", "8000"))
            )
        )
        ...
        self.enable_dashboard: bool = overrides.get(
            "enable_dashboard",
            os.getenv("AGENTIC_IAM_ENABLE_DASHBOARD", os.getenv("ENABLE_DASHBOARD", "true")).lower()
            == "true",
        )
    ...
    def _create_directories(self):
        ...
        try:
            ...
            logging.getLogger(__name__).debug(
                "Secret manager not available; using defaults/environment"
            )
